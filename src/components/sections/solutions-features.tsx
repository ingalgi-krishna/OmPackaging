                                ...
                                <div className="h-full flex flex-col text-center bg-white p-8 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group border border-gray-100">
                                    ...
                                    <div className="flex justify-center mb-6">
                                        <motion.div
                                            ...
                                            className="w-20 h-20 bg-gradient-to-br from-picton/10 to-[#002B5B]/10 rounded-2xl flex items-center justify-center group-hover:from-picton/20 group-hover:to-[#002B5B]/20 transition-all duration-300"
                                        >
                                            <IconComponent size={36} className="text-[#002B5B] group-hover:text-picton transition-colors duration-300" />
                                        </motion.div>
                                    </div>

                                    {/* Title - Fixed height for alignment */}
                                    <div className="mb-4">
                                        <h3 className="text-xl font-semibold text-[#002B5B] group-hover:text-picton transition-colors duration-300 min-h-[3rem] flex items-center justify-center">
